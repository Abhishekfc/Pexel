  ...
  return (
    ...
    >
      ...
      <div className='text-center'>
        ...
        <div className='text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-6'>${price}
...
const Pricing = () => {
  const plans = [
    ...
    },
    {
      ...
      featured: true,
      planId: "cplan_31I9zQgcwQxOMGVEPTx2bp1bR5A",
